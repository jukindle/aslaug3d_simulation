...
class AslaugPolicy(ActorCriticPolicy):
    def __init__(self, sess, ob_space, ac_space, n_env, n_steps, n_batch,
        ...
        with tf.variable_scope("model/scan_block", reuse=reuse):
            ...
            sl_1 = tf.layers.Conv1D(2, 9, activation=lrelu, name="sc_1")
            ...
            sl_5 = tf.layers.Conv1D(8, 5, activation=lrelu, name="sc_5")
            sl_6 = tf.layers.Conv1D(16, 5, activation=lrelu, name="sc_6")
            sl_7 = tf.layers.MaxPooling1D(3, 3, name="sc_7")
            sl_8 = tf.layers.Conv1D(32, 3, activation=lrelu, name="sc_8")
            sl_9 = tf.layers.Conv1D(64, 3, activation=lrelu, name="sc_9")
            sl_10 = tf.layers.Flatten(name="sc_10")
            sl_11 = tf.layers.Dense(128, activation=lrelu, name="sc_11")
            sl_12 = tf.layers.Dense(64, activation=lrelu, name="s1_12")
